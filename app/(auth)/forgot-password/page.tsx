...
export default function ForgotPassword() {
    ...
    const mutation = useMutation({
        ...
        onSuccess: () => {
            toast.success('If the email exists in our system, you will receive a password reset email')
    ...
    return (
        <>
            <div className="flex flex-col items-center mt-20">
                <h1 className="text-xl text-indigo-600 font-semibold text-center">Forgot Password</h1>
